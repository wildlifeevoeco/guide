...
1. Host your repository on GitHub. Note: you can select the [`wildlifeevoeco`](https://github.com/wildlifeevoeco/) as "Owner" if this is a lab paper. If you don't see that as an option, ask Alec to add you as a member of that group.
