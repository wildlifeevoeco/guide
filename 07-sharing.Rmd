...
TODO: fill alternative option - switch remote to github and pull mirror from gitlab

Two options and it depends on if you'd like your repository to be mirrored over
(dynamic, with updates) or imported (static, one time snapshot). Using the 
GitHub Importer is easy but will only take a static snapshot. Otherwise,
use an access token and mirror the repository for a dynamic link between GitLab 
