...
Quarto (see below) has been developed to provide some advantages over R Markdown by including lots of developments and extensions to R Markdown immediately available in Quarto. See more about the differences [here](https://quarto.org/docs/faq/rmarkdown.html#quarto-sounds-similar-to-r-markdown.-what-is-the-difference-and-why-create-a-new-project). 
