...
-   Claus Wilke's course [Data Visualization in
    R](https://wilkelab.org/SDS375/syllabus.html), book [Fundamentals of
...
"What if I look at four separate chunks of the data, with approximately
...
"What if I look at four separate chunks of the data, with the equal
...
"What if I look at four separate chunks of the data, with a specific
width of values in each group?"
...
Lots of examples of spatial plotting of vector data in the
[study-area-figure](https://gitlab.com/WEEL_grp/study-area-figures)
repository.
...
reduce the resolution. It also might help to write the plot out to a
PDF, instead of trying to view it directly in the RStudio window.
...
-   Turn ggplots into interactive plots:
    [`plotly`](https://github.com/plotly/plotly.R#getting-started)
